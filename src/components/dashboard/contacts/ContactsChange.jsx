...
const ContactsChange = (props) => {
  ...
  return (
    <div className="bg-zinc-900 p-4 rounded">
      ...
      <button onClick={handleSubmit} className="w-full py-1 my-2 rounded-lg bg-gradient-to-r from-red-500 to-pink-500 shadow-lg hover:shadow-pink-500/30 transition-all">
      {loading ? <Loader width="w-4" height="h-4"/> : <p>Actualizar</p>}
      </button>
    </div>
  );
};
