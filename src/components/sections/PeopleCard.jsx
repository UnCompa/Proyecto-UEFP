...
export default function PeopleCard({teacher,work,content,img = ""}) {
  return (
    <div className="h-full w-full bg-zinc-200 dark:bg-zinc-900 p-2 rounded shadow-lg hover:bg-zinc-300 dark:hover:bg-zinc-800 transition-all">
      <figure className="flex items-center justify-center p-4">
        <img className="aspect-square rounded-full h-full w-32 border-2 border-black dark:border-white p-1 object-cover" src={img} alt="" />
      </figure>
      <Divider />
