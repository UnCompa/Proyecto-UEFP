...
export default function PeopleCard({teacher,work,content,img = ""}) {
  return (
    <motion.div initial={{y: 100}} whileInView={{y:0}} className="h-full w-full bg-zinc-200 dark:bg-zinc-950/50 p-2 rounded shadow-lg hover:bg-zinc-300 dark:hover:bg-zinc-800 transition-all">
