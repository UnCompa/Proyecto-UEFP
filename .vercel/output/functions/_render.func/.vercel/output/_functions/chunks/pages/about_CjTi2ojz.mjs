...
/* empty css                              */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderSlot, g as renderComponent } from '../astro_DLqDAIH1.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
import 'cssesc';
import { l as languages, u as useTranslatedPath, g as getLangFromUrl, a as useTranslations, $ as $$ThemeIcon, b as $$Layout } from './404_CQZJFclf.mjs';
import { FaAt, FaPhone, FaEnvelope, FaGraduationCap, FaUsers, FaHouse, FaTiktok, FaFacebook, FaPen, FaStar as FaStar$1 } from 'react-icons/fa6';
...
function NavLink({ to, text }) {
  return /* @__PURE__ */ jsxs(
    ...
    {
      href: `${to}`,
      className: "rounded-full px-4 py-2 flex items-center gap-x-2 font-Rubik hover:rounded-full hover:ring-2 hover:ring-black hover:bg-zinc-900 hover:text-white dark:hover:ring-white dark:hover:bg-zinc-100 dark:hover:text-black transition-colors duration-200 ease-out",
      children: [
        text,
...
function NavBar({ url, pathName, children }) {
  ...
  return /* @__PURE__ */ jsxs(
    "nav",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("a", { href: "/", children: /* @__PURE__ */ jsx("img", { src: isDarkMode ? "/imgs/UEFPescudoblanco.png" : "/imgs/UEFPescudoblack.png", className: "h-16 lg:h-24" }) }),
        /* @__PURE__ */ jsx("h3", { className: "block text-center text-xl font-Rubik uppercase font-bold lg:hidden", children: mensaje1 }),
        /* @__PURE__ */ jsxs(
          "ul",
          {
            className: `bg-slate-300 dark:bg-black h-screen fixed w-1/2 top-0 right-0 p-4 flex flex-col gap-y-4 transition-all ${openMenu ? "translate-x-0 lg:translate-x-0" : " translate-x-full lg:translate-x-0"} lg:h-full lg:relative lg:top-0 lg:flex lg:flex-row lg:items-center lg:justify-center lg:w-max lg:bg-transparent lg:gap-x-2 lg:transition-none`,
            children: [
              ...
              /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: `/${lang}/signin`, className: "py-2 px-4 border border-black dark:border-white rounded-full", children: "Iniciar Sesion" }) })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
...
}, "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/CardImgReveal.astro", void 0);
...
}, "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/CardInfo.astro", void 0);
...
const $$FooterLink = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { to, text, target } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(`${to}`, "href")}${addAttribute(target ? "_blank" : "_self", "target")} class="px-2 w-max  text-start py-1 flex justify-center gap-x-2 font-Rubik font-bold text-zinc-900 dark:text-zinc-200 hover:text-zinc-900 dark:hover:text-zinc-500 hover:font-normal transition-all duration-200 ease-out"> ${text} </a>`;
}, "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/FooterLink.astro", void 0);
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const t = useTranslations(lang);
  return renderTemplate(_a || (_a = __template(['<script async>\n  // Funci\xF3n para manejar el cambio de clase\n  function handleClassChange() {\n    const img = document.getElementById("img-logo");\n    const htmlElement = document.querySelector("html");\n    const classes = htmlElement?.classList;\n\n    if (classes?.contains("dark")) {\n      // El tema cambi\xF3 a oscuro\n      if (img instanceof HTMLImageElement) {\n        img.src = "/imgs/UEFPescudoblanco.png";\n      } else {\n        console.error("El elemento no es una imagen");\n      }\n    } else {\n      // El tema cambi\xF3 a claro\n      if (img instanceof HTMLImageElement) {\n        img.src = "/imgs/UEFPescudoblack.png";\n      } else {\n        console.error("El elemento no es una imagen");\n      }\n    }\n  }\n\n  // Observar cambios en la clase del elemento <html>\n  document.addEventListener("DOMContentLoaded", () => {\n    handleClassChange(); // Llama a la funci\xF3n al cargar la p\xE1gina para establecer el tema inicial\n    document.addEventListener("transitionend", handleClassChange); // Observa cambios de clase\n  });\n<\/script> ', '<footer class="bg-zinc-200 dark:bg-zinc-900 h-max w-full py-4"> <div class=" container mx-auto grid grid-col-1 md:grid-cols-2 lg:grid-cols-4 place-content-center"> <div class="h-full w-full flex flex-col items-center justify-center"> <a href="/"> <img id="img-logo" alt="Escudo de la institucion" class="size-[10em] aspect-square"></a> </div> <div class="p-4"> <h3 class="text-3xl font-Rubik font-bold underline decoration-2 decoration-acent-2 text-start text-black dark:text-white"> ', ' </h3> <ul class="flex flex-col py-2 gap-y-2"> <li class="flex items-center"> ', " ", ' </li> <li class="flex items-center"> ', " ", ' </li> </ul> </div> <div class="p-4"> <h3 class="text-start text-3xl font-Rubik font-bold underline decoration-2 decoration-acent-2 text-black dark:text-white"> ', ' </h3> <ul class="flex flex-col py-2 gap-y-2"> <li class="flex items-center"> ', " ", ' </li> <li class="flex items-center"> ', " ", ' </li> <li class="flex items-center"> ', " ", ' </li> <!-- <li class="flex items-center">\n          <FaNewspaper />\n          <FooterLink to="news" text={t("footer-paginas-noticias")} />\n        </li> --> <li class="flex items-center"> ', " ", ' </li> </ul> </div> <div class="p-4"> <h3 class="text-3xl font-Rubik font-bold underline decoration-2 decoration-acent-2 text-start text-black dark:text-white"> ', ' </h3> <ul class="flex flex-col py-2 gap-y-2"> <li class="text-start font-bold flex gap-2 items-center"> ', " <p>", '</p> </li> <li class="text-start font-bold flex gap-2 items-center"> ', " <p>", '</p> </li> </ul> </div> </div> <div class="flex items-center justify-around p-4"> <ul class="flex text-black dark:text-white"> ', ' </ul> <div> <span class="text-gray-500 text-sm flex items-center"> <span>\xA9 Copyright</span> </span> </div> </div> </footer>'])), maybeRenderHead(), t("footer-redes"), renderComponent($$result, "FaFacebook", FaFacebook, { "className": "font-bold text-xl" }), renderComponent($$result, "FooterLink", $$FooterLink, { "target": true, "to": "https://www.facebook.com/unidadeducativafiscal.pichincha", "text": t("footer-redes-facebook") }), renderComponent($$result, "FaTiktok", FaTiktok, { "className": "font-bold text-xl" }), renderComponent($$result, "FooterLink", $$FooterLink, { "target": true, "to": "https://www.tiktok.com/@uef.pichincha", "text": t("footer-redes-tiktok") }), t("footer-paginas"), renderComponent($$result, "FaHouse", FaHouse, {}), renderComponent($$result, "FooterLink", $$FooterLink, { "to": "/", "text": t("footer-paginas-inicio") }), renderComponent($$result, "FaUsers", FaUsers, {}), renderComponent($$result, "FooterLink", $$FooterLink, { "to": "about", "text": t("footer-paginas-sobrenosotros") }), renderComponent($$result, "FaGraduationCap", FaGraduationCap, {}), renderComponent($$result, "FooterLink", $$FooterLink, { "to": "academics", "text": t("footer-paginas-academicos") }), renderComponent($$result, "FaEnvelope", FaEnvelope, {}), renderComponent($$result, "FooterLink", $$FooterLink, { "to": "contacts", "text": t("footer-paginas-contactos") }), t("footer-contacto"), renderComponent($$result, "FaPhone", FaPhone, {}), t("footer-contacto-telefono"), renderComponent($$result, "FaAt", FaAt, {}), t("footer-contacto-email"), renderComponent($$result, "ChangeLanguage", ChangeLanguage, { "lang": lang }));
}, "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/Footer.astro", void 0);
...
}, "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/Navigation.astro", void 0);
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const lang = getLangFromUrl(Astro2.url);
  const t = useTranslations(lang);
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Sobre nosotros", "icon": "/imgs/UEFPescudoblanco.png" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navigation", $$Navigation, {})} ${maybeRenderHead()}<main class="h-full bg-zinc-400 dark:bg-zinc-900"> <section class="h-screen"> <div class="absolute -bottom-28 w-full"> ${renderComponent($$result2, "Wave", Wave, { "className": "fill-zinc-200 dark:fill-zinc-800" })} </div> <div class="grid lg:grid-cols-2 place-content-center font-Rubik h-full px-8"> <div class="flex flex-col p-4 gap-y-4 justify-center"> <h2 class="text-5xl font-bold animate-blurred-fade-in pt-4"> ${t("about-hero-title")} </h2> <p class="animate-fade-in-up">
Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore
            voluptatem quibusdam cum quisquam repudiandae minus ea eligendi
            ratione distinctio eos, iste officia. Cum ut fugiat odit aspernatur
            doloribus. Ullam, quis! Lorem ipsum dolor sit amet, consectetur
            ...
            mollitia accusantium earum. Perferendis porro culpa vitae id nihil
            distinctio, incidunt eos atque est soluta.
</p> </div> <div class="flex py-12 justify-center items-center h-full"> ${renderComponent($$result2, "IlustrationPerson", IlustrationPerson, {})} </div> </div> </section> <section class="bg-zinc-200 dark:bg-zinc-800 h-max"> <div class="p-4"> <h3 class="text-6xl font-Rubik font-bold text-center"> ${t("nuestra-historia-title")} </h3> <div class="h-full"> ${renderComponent($$result2, "CardInfo", $$CardInfo, { "text": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore voluptatem quibusdam cum quisquam repudiandae minus ea eligendi ratione distinctio eos, iste officia. Cum ut fugiat odit aspernatur doloribus. Ullam, quis! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi dolore doloribus error sunt sapiente illo, mollitia accusantium earum. Perferendis porro culpa vitae id nihil distinctio, incidunt eos atque est soluta.", "title": "Desde los inicios", "img": "/public/imgs/pexels-designecologist-1779487.jpg" })} ${renderComponent($$result2, "CardInfo", $$CardInfo, { "invert": true, "text": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore voluptatem quibusdam cum quisquam repudiandae minus ea eligendi ratione distinctio eos, iste officia. Cum ut fugiat odit aspernatur doloribus. Ullam, quis! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi dolore doloribus error sunt sapiente illo, mollitia accusantium earum. Perferendis porro culpa vitae id nihil distinctio, incidunt eos atque est soluta.", "title": "Desde los inicios", "img": "/public/imgs/pexels-designecologist-1779487.jpg" })} </div> </div> <div class="absolute bottom-0 bg-white/20 h-96 w-96 rounded-full blur-3xl"></div> </section> <section class="relative bg-zinc-200 dark:bg-zinc-800 pt-10"> <div class="absolute right-0 bottom-0 bg-yellow-400/10 h-96 w-96 rounded-full blur-3xl"></div> <div class="w-full"> <h3 class="font-Rubik text-5xl text-center font-bold py-4">${t("valores-title")}</h3> </div> <div class="h-full py-8 bg-black/10 p-8"> ${renderComponent($$result2, "SelectOption", App, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/SelectOption", "client:component-export": "default" })} </div> </section> <section class="relative bg-zinc-200 dark:bg-zinc-800 pt-10"> <div class="w-full"> <h3 class="font-Rubik text-5xl text-center font-bold py-4"> ${t("objectivos-title")} </h3> </div> <div class="h-full py-8 bg-black/10 p-8"> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"> ${renderComponent($$result2, "Objectives", Objectives, { "title": "Ejercer estudiantes", "text": "Preparar estudiantes para que tenga las aptitudes adecuadas para el mundo laboral", "color": "pink", "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/sections/Objectives", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "FaPen", FaPen, {})} ` })} ${renderComponent($$result2, "Objectives", Objectives, { "title": "Mejorar estudiantes", "text": "Preparar estudiantes para que tenga las aptitudes adecuadas para el mundo laboral", "color": "green", "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/sections/Objectives", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "FaStar", FaStar$1, {})} ` })} ${renderComponent($$result2, "Objectives", Objectives, { "title": "Estudios de calidad", "text": "Preparar estudiantes para que tenga las aptitudes adecuadas para el mundo laboral", "color": "sky", "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/components/sections/Objectives", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "FaPen", FaPen, {})} ` })} </div> </div> <div class="w-full"> <h3 class="font-Rubik text-5xl text-center font-bold py-4"> ${t("nuestro-equipo-title")} </h3> </div> <div class="h-full py-8 bg-black/10 p-8"> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 bg-zinc-100  dark:bg-zinc-900 p-4"> ${renderComponent($$result2, "PeopleCard", PeopleCard, { "teacher": "Ing. Juan P\xE9rez", "content": "Meastro especialista en quimica, explicando didacticamente a los estudiantes", "work": "Docente de Quimica", "img": "/imgs/persona.jpg" })} ${renderComponent($$result2, "PeopleCard", PeopleCard, { "teacher": "Msc. Pablito", "content": "Declaraciones aqui", "work": "Prueba", "img": "/imgs/persona.jpg" })} ${renderComponent($$result2, "PeopleCard", PeopleCard, { "teacher": "Ing. Alisa Fuentes", "content": "Declaraciones aqui", "work": "Prueba", "img": "/imgs/programacion.jpeg" })} </div> </div> </section> </main> ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/pages/es/about.astro", void 0);

const $$file = "C:/Users/Santiago Mosquera/Desktop/PROGRAMACION/Proyecto-UEFP/src/pages/es/about.astro";
const $$url = "/es/about";
...
export { $$Navigation as $, Diamond as D, NavBar as N, $$Footer as a, $$CardInfo as b, about$1 as c, about as d };
