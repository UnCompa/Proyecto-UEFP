/* empty css                          */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, f as renderComponent, e as addAttribute } from '../astro_cRpK2x-Z.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
import 'cssesc';
import { g as getLangFromUrl, u as useTranslations, b as $$ThemeIcon, N as NavBar, c as $$CardInfo, d as $$Footer, a as $$Layout, D as Diamond } from './about_BdJfi4PC.mjs';
/* empty css                          */
...
}, "C:/PAILLACHO BRANDON/DISE\xD1OWEB/Proyecto-UEFP/src/components/Hero.astro", void 0);
...
}, "C:/PAILLACHO BRANDON/DISE\xD1OWEB/Proyecto-UEFP/src/components/Header.astro", void 0);
...
}, "C:/PAILLACHO BRANDON/DISE\xD1OWEB/Proyecto-UEFP/src/components/VideoPlayer.astro", void 0);
...
}, "C:/PAILLACHO BRANDON/DISE\xD1OWEB/Proyecto-UEFP/src/components/VideoYTPlayer.astro", void 0);
...
}, "C:/PAILLACHO BRANDON/DISE\xD1OWEB/Proyecto-UEFP/src/pages/en/index.astro", void 0);

const $$file$2 = "C:/PAILLACHO BRANDON/DISEÑOWEB/Proyecto-UEFP/src/pages/en/index.astro";
const $$url$2 = "/en";
...
}, "C:/PAILLACHO BRANDON/DISE\xD1OWEB/Proyecto-UEFP/src/pages/index.astro", void 0);

const $$file$1 = "C:/PAILLACHO BRANDON/DISEÑOWEB/Proyecto-UEFP/src/pages/index.astro";
const $$url$1 = "";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const lang = getLangFromUrl(Astro2.url);
  const t = useTranslations(lang);
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Unidad Educativa Fiscal Pichincha | Web Oficial", "icon": "/public/imgs/UEFPescudoblanco.png" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, {})} ${maybeRenderHead()}<main class="h-full w-full bg-zinc-50 dark:bg-zinc-800 grid place-content-center gap-y-4"> <section class="bg-transparent w-full h-full"> ${renderComponent($$result2, "CardInfo", $$CardInfo, { "img": "/imgs/programacion.jpeg", "title": t("main-mision"), "text": t("main-mision-text") }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Diamond", Diamond, { "height": "16px", "width": "16px" })} ` })} ${renderComponent($$result2, "CardInfo", $$CardInfo, { "img": "/imgs/programacion.jpeg", "title": t("main-vision"), "title": "Vision", "text": t("main-vision-text") }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Diamond", Diamond, { "height": "16px", "width": "16px" })}` })} </section> <section class="container mx-auto grid place-content-center w-full"> <h2 class="text-black dark:text-zinc-100 text-center text-5xl py-4 font-Rubik"> ${t("main-presentacion")} </h2> ${renderComponent($$result2, "VideoPlayer", $$VideoPlayer, { "url": "/videos/test.mp4" })} </section> <section class="container mx-auto grid place-content-center h-full w-full"> <!-- <VideoYTPlayer url="https://youtu.be/wL8DVHuWI7Y?list=RDrNZ17DDx0Jg" /> --> </section> </main> ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "C:/PAILLACHO BRANDON/DISE\xD1OWEB/Proyecto-UEFP/src/pages/es/index.astro", void 0);

const $$file = "C:/PAILLACHO BRANDON/DISEÑOWEB/Proyecto-UEFP/src/pages/es/index.astro";
const $$url = "/es";
